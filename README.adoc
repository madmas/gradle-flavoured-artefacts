...
Please find the article that explains what this example project demonstrates at link:https://karakun.github.com/2018/06/29/flavoured-artefacts-with-gradle.html[Karakun Developer Hub / Gradle: flavoured artefacts from a multi-module build]
